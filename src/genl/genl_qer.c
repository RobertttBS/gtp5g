...
static int qer_fill(struct qer *qer, struct gtp5g_dev *gtp, struct genl_info *info)
{
    ...
    /*
    printk("green low limit: %d, yellow low limit: %d\n", qer->queue_profile.low_limit[0], qer->queue_profile.low_limit[1]);
    printk("green high limit: %d, yellow high limit: %d\n", qer->queue_profile.high_limit[0], qer->queue_profile.high_limit[1]);
    printk("green max drop prob: %d, yellow max drop prob: %d\n", qer->queue_profile.max_drop_prob[0], qer->queue_profile.max_drop_prob[1]);
    printk("green count: %d, yellow count: %d\n", qer->queue_profile.count[0], qer->queue_profile.count[1]);
