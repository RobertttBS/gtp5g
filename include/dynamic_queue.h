...
extern void d_queue_push(struct dynamic_queue *, struct queue_data *);
extern void d_queue_pop(struct dynamic_queue *);
extern struct queue_data *d_queue_get_front(struct dynamic_queue *);
extern struct queue_data *d_queue_get_rear(struct dynamic_queue *);
